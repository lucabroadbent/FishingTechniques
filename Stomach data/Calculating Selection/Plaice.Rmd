...
This isnt a terrible shift. (It is the best shift we have, here is the 
parameters)
...
Ok, so the number density to biomass is not too bad. WIll try exponential
for fun.
...
The exponential fit is not good. SO we will use the  mixture gaussian.