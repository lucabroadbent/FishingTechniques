...
The PPMR flucuates around 5, which I think is good enough to state that 
PPMR is constant across pred sizes.
...
It really doesn't look right that it the biggest peak for the density 
when weigted by biomass is at nearly 0 PPMR.
...
Fitting to biomass works well for hte exponential
