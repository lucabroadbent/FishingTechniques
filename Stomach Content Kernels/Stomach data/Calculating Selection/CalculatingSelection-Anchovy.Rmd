...
Okay, the distribution fit here isn't good. But when I do the same without 
including the data from the anchovy and sardines file, it looks a lot better.

I am going to plot them now separately.
...
#ok to this model states that 99% percent of the wprey is not due to the region or year
#therefore it must all be due to the predator selection

```

I think we need more data, as currently there isn't too much, and if we can 
figure out how to use the anchovies and sardines datafile, we can include that too, 
but currently it completely different. 

Still, the normal distribution fits the anchovy predation kernel very well, 
