...
sprat <- sprat%>%filter(pred_weight_g<2000)
...
This looks good, it doesn't change much. I am not sure which data I should use 
though, as ICES is grouped, and DAPSTOM has prey weight estimated.
...
Ok, fitting to biomass and shifting to number is okay, but it is still not
that good.
...
Fitting to biomass and shifting to number is very good. Use this I think.
