...
ui <- fluidPage(
  ...
  font-size: 16px; /* Adjust icon size if needed */
    ...
    #OKAY, IF THE CONTENT OF THE BUTTON CONTAINS ANY . / () , IT WONT WORK!!.
      ...
      $('#infoButtonSpecies').popover({
      title: '',
      content: 'Slider value indicates the starting biomass of the species. Example: to increase the starting population of a given species by 20%, set value on the slider to 1.2. To decrease by 20%, set value to 0.8.',
      placement: 'right',
      trigger: 'hover'
     });
     $('#infoButtonMort').popover({
      title: '',
      content: 'Slider value indicates the change in mortality of a species. Example: to increase the mortality of a species by 1%, set the value of the slider to 0.01. This will change the mortality throughout the simulation to be 1% higher. If you want it to be a 1% decrease, set value to -0.01',
      placement: 'right',
      trigger: 'hover'
    });
  });
        ...
        grid_container(
          ...
          grid_card(
            ...
            card_body(
              sliderInput(
                inputId = "species",
                label = HTML("Starting Biomass %     <button id='infoButtonSpecies' class='btn btn-info btn-xs' type='button'><i class='fa fa-info-circle'></i></button>"),
                min = 0,
                max = 2,
                value = 1,
                step = 0.01,
        ...
        grid_container(
          ...
          grid_card(
            ...
            card_body(
              sliderInput(
                inputId = "mortspecies",
                label = HTML("Mortality Added <button id='infoButtonMort' class='btn btn-info btn-xs' type='button'><i class='fa fa-info-circle'></i></button>"),
                min = -0.5,
                max = 0.5,
                value = 0,
                step = 0.01,
