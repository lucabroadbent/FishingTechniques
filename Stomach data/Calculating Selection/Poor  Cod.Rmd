...
This looks like a double gaussian?

(There is a datapoint with a very high nprey, I will remove)

```{r}

ggplot(sprat)+
  geom_point(aes(x=nprey_perpred, y=log(ppmr)))

```

At PPMR of 10, there are 3 points with a much higher nprey_perpred, I will remove



```{r}

sprat <- sprat%>%filter(nprey_perpred<160)
...
This isnt a nice shift, it is at too high a ppmr
...
This fits very well. ITs a little off, but :).